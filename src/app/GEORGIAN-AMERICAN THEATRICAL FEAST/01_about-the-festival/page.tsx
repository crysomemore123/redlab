    ...
    <div className={styles.aboutContainer}>
      ...
      <div className={styles.teamMember}>
        ...
        <div className={styles.profileInfo}>
          ...
          <p>
            Is a New York-based stage and opera director and 
            choreographer. Recent productions include the world 
            premieres of Contemporary Georgian play <em>Stalin Lab, The 
            Seagull</em> (TheatreLab), <em>The Brashworrier's Apprentice, Nicholas and 
            Alexandra</em> and <em>Night About the City</em> (all with Amos at the Oracle 
            Theater). <em>Hamlet A Version</em>, an adaptation of <em>Hamlet</em> in English and 
            its anthology by Pavel at Westminster Choir College. 
            International productions include Mozart's <em>Don 
            Giovanni</em> co-produced with The Georgian State Opera, <em>Twilight 
            After the lover</em> in co-op by Alexander Pushkin (Marjanishvili 
            Theater, Tbilisi, Georgia), and Glen Cario Menotti's <em>The 
            Telephone</em> which was produced in her native Tbilisi, 
            Georgia. She holds a master's degree in stage directing from 
            the Russian Academy of Performing Arts (GITIS, Moscow). She 
            is a founding member of the League of Professional Theater 
            and has extensive film and visual arts credentials. Her films <em>As 
            Apple</em> and <em>Stigma</em> received awards at the Kinoshock Film Festival 
            in Anapa, Russia.
          </p>
        </div>
      </div>
      ...
      <div className={styles.footer}>
        <p>© Red Lab Productions 2017 | ALL RIGHTS RESERVED</p>
        <div className={styles.socialLinks}>
          <Link href="https://facebook.com" target="_blank">
            <span className={styles.socialIcon}>
              {/* Replace with your Facebook icon component or image */}
              F
            </span>
          </Link>
          <Link href="https://twitter.com" target="_blank">
            <span className={styles.socialIcon}>
              {/* Replace with your Twitter icon component or image */}
              T
            </span>
          </Link>
          <Link href="https://instagram.com" target="_blank">
            <span className={styles.socialIcon}>
              {/* Replace with your Instagram icon component or image */}
              I
            </span>
          </Link>
        </div>
